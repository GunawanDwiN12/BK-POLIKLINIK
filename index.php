    ...
    <div class="container-fluid home-container">
        <div class="row align-items-center">
            <div class="col-md-6 text-center">
                <img src="./images/hospital.png" class="img-fluid mb-4" alt="Hospital Image">
            </div>
            <div class="col-md-6">
                ...
                <ul class="list-group fs-6">
                    <li class="list-group-item">Daftar sebagai pasien dan jadwalkan periksa dan temu dengan dokter</li>
                    <li class="list-group-item">Jadwal dokter praktik mulai Senin-Sabtu</li>
                    <li class="list-group-item">Tersedia banyak Poliklinik</li>
                </ul>

                <div class="text-center mt-4">
                    <h4>Daftar secara online sekarang!</h4>
                </div>
                <ul class="list-group fs-6">
                    <li class="list-group-item">Daftar pasien baru</li>
                    <li class="list-group-item">Catat Nomor RM anda untuk login</li>
                    <li class="list-group-item">Login untuk memilih poli dan dokter anda</li>
                    <li class="list-group-item">Tunggu jadwal yang telah ditentukan</li>
                    <li class="list-group-item">Pembayaran dapat dilihat melalui riwayat pasien</li>
                </ul>
            </div>
        </div>
    </div>
